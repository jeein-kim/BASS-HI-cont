...
These datasets were obtained from two projects (_VLA/20A-123_ and _VLA/23B-079_) observed with the Karl G. Jansky Very Large Array (VLA).  
...
The data were processed and reduced using _CASA 6.5.4-9 CASAtools:v1.0.0_.  
